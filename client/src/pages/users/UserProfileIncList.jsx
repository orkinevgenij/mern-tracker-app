...
const UserProfileIncList = () => {
  ...
  const { profile, userLoading, userAppErr, userServerErr } = useSelector((state) => state?.users);
          ...
          <div className='container-fluid'>
            <div className='position-relative border rounded-2'>
              ...
              <div className='pt-8 px-8 mb-8'>
                ...
                <p className='mb-0'>Below is the history of your income transactions records</p>
                <Link to='/add-income' className='btn  btn-outline-primary me-2 m-2'>
                  New Income
                </Link>
              </div>
